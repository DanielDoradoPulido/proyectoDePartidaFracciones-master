...
public class divDificil extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					divDificil frame = new divDificil();
	 ...
	 */
	public divDificil() {
		setTitle("MathApp - Operaciones de Division  (Dificil)");
		...
		lblNewLabel_11 = new JLabel("22");
		lblNewLabel_11.setFont(new Font("Tahoma", Font.PLAIN, 14));
		lblNewLabel_11.setBounds(120, 127, 28, 14);
		...
		lblNewLabel_13 = new JLabel("17");
		lblNewLabel_13.setFont(new Font("Tahoma", Font.PLAIN, 14));
		lblNewLabel_13.setBounds(63, 268, 28, 14);
		contentPane.add(lblNewLabel_13);
		
		lblNewLabel_14 = new JLabel("10");
		...
		lblNewLabel_24 = new JLabel("3");
		lblNewLabel_24.setFont(new Font("Tahoma", Font.PLAIN, 14));
		lblNewLabel_24.setBounds(548, 297, 46, 14);
		contentPane.add(lblNewLabel_24);
		
		JLabel lblNewLabel = new JLabel("DIVIDE LAS FRACCIONES");
		lblNewLabel.setFont(new Font("Tahoma", Font.PLAIN, 26));
		lblNewLabel.setBounds(241, 27, 409, 64);
