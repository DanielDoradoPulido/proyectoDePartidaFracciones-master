...
public class mcdFacil extends JFrame {
	...
	public mcdFacil() {
		...
		JLabel lblNewLabel_1 = new JLabel("M.C.D (9   Y   15)");
		lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblNewLabel_1.setBounds(70, 136, 153, 14);
		contentPane.add(lblNewLabel_1);
		
		
		lblNewLabel_3 = new JLabel("M.C.D (12   Y   18)");
		lblNewLabel_3.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblNewLabel_3.setBounds(432, 136, 174, 14);
		contentPane.add(lblNewLabel_3);
		
		lblNewLabel_5 = new JLabel("M.C.D(20   Y   30)");
		lblNewLabel_5.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblNewLabel_5.setBounds(70, 273, 179, 14);
		contentPane.add(lblNewLabel_5);
		
		lblNewLabel_6 = new JLabel("M.C.D (3 ,9  Y  27)");
		lblNewLabel_6.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblNewLabel_6.setBounds(432, 273, 174, 14);
		...
		lblNewLabel.setBounds(164, 36, 692, 71);
