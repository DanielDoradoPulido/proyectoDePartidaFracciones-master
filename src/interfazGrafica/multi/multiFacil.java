...
public class multiFacil extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					multiFacil frame = new multiFacil();
	 ...
	 */
	public multiFacil() {
		setTitle("MathApp - Operaciones de Multiplicacion  (Facil)");
		...
		JLabel lblNewLabel_1 = new JLabel("_______ X _______  = ");
		...
		lblNewLabel_3 = new JLabel("_______X _______  = ");
		...
		lblNewLabel_6 = new JLabel("_______ X_______  = ");
		...
		lblNewLabel_20 = new JLabel("16");
		lblNewLabel_20.setFont(new Font("Tahoma", Font.PLAIN, 14));
		lblNewLabel_20.setBounds(547, 153, 31, 14);
		...
		lblNewLabel.setBounds(190, 27, 406, 65);
